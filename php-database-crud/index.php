...
// Sanitize $id here - check input is definitely an int and not malicious SQL
...
// Execute it here
$updateBookQuery->execute(['title' => $title, 'author' => $author, 'year' => $year]);
...
// Print all books
$allBooks =  $db->prepare('SELECT * FROM books');
$allBooks->execute();$allBooksResults = $allBooks->fetchAll(PDO::FETCH_ASSOC);

print_r($allBooksResults);
